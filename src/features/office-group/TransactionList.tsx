...
interface SortState {
  key: "chiefOfficeName" | "officeName";
  asc: boolean;
}
...
const TransactionList: React.FC = () => {
  ...
  // const sortBy = (key: "officeName" | "customer"): void => {
  //   setSort((prev) => ({
  //     key,
  ...
  const sortedRows: OfficeGroup[] = React.useMemo(() => {
  ...
  const filteredRows: OfficeGroup[] = useMemo(() => {
    return sortedRows.filter(
      (row) =>
        row.chiefOfficeName?.toLowerCase().includes(search?.toLowerCase()) ||
        (row.officeName &&
          row.officeName?.toLowerCase().includes(search?.toLowerCase()))
    );
  }, [sortedRows, search]);
          ...
          <thead>
            <tr className="border-b border-gray-200 dark:divide-gray-800 dark:border-gray-800">
              ...
              <th className="p-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400">
                <div
                  className="flex cursor-pointer items-center gap-3"
                  onClick={() => sortBy("chiefOfficeName")}
                >
                  <p className="text-theme-xs font-medium text-gray-500 dark:text-gray-400">
                    Office Leader
                  </p>
                  <span className="flex flex-col gap-0.5">
                    <svg
                      className={
                        sort.key === "chiefOfficeName" && sort.asc
                          ? "text-gray-800 dark:text-gray-400"
                          : "text-gray-300"
                      }
                      width="8"
              ...
              >
                ...
                <td className="p-4 whitespace-nowrap">
                  ...
                  <div className="flex gap-6 justify-center text-gray-500">
                    {/* <SquarePen className="size-5 mt-[1px]" /> */}
                    <Tooltip>
                      <TooltipTrigger>
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <div className="text-gray-500 hover:text-error-500 dark:hover:text-error-500 h-[25px] dark:text-gray-400">
                          {/* <SquarePen className="size-5" /> */}
