...
const AgentGroupTable: React.FC<AgentGroupTableProps> = ({
  agentGroupsByOfficeGroupCode,
}: AgentGroupTableProps) => {
  // const [selectedTab, setSelectedTab] = useState<string>("All");
  // const [showFilter, setShowFilter] = useState<boolean>(false);
  const [rows] = useState<AgentGroup[]>(agentGroupsByOfficeGroupCode || []);
  ...
  // const getPaginatedRows = (): AgentGroup[] => {
  //   const sorted: AgentGroup[] = [...rows];
  //   if (sort.column) {
  //     sorted.sort((a: AgentGroup, b: AgentGroup) => {
  //       let valA = a[sort.column as keyof AgentGroup];
  //       let valB = b[sort.column as keyof AgentGroup];
  ...
  const paginatedRows: AgentGroup[] = getPaginatedRows();
      ...
      <div className="flex flex-col gap-4 border-b border-gray-200 px-4 py-4 sm:px-5 lg:flex-row lg:items-center lg:justify-between dark:border-gray-800">
        ...
        <div className="flex-shrink-0">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Agent groups associated with office
          </p>
        </div>
