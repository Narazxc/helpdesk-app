...
// | "position" | "location" | "age" | "date" | "salary";
type SortKey = "name";
type SortOrder = "asc" | "desc";
...
export default function AssetTypeTable() {
  ...
  }, [sortKey, sortOrder, searchTerm, assetTypes]);
            ...
            <TableBody>
              {currentData.map((item, i) => (
                <TableRow key={i + 1} className="h-0.5 group">
                  ...
                  <TableCell className="px-4 py-2 font-normal text-gray-800 border max-w-[2rem] border-gray-100 dark:border-white/[0.05] text-theme-sm dark:text-white/90 whitespace-nowrap ">
