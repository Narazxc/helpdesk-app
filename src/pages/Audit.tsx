...
import { useCategoryTypeById } from "@/features/category-type/useCategoryType";
import { useModal } from "@/hook/useModal";
import TypeDataTable, {
  type ColumnConfig,
} from "@/features/request-type/TypeDataTable";
import useAssetsByCategoryTypeCode from "@/features/asset-type/useAssetsByCategoryTypeCode";
import type { AssetType } from "@/types/asset-type";

export default function Audit() {
  const { categoryType, isLoading, error } = useCategoryTypeById("1");
  ...
  if (error) return <p>Error loading category type</p>;
  if (!categoryType) return <p>Category type not found</p>;
