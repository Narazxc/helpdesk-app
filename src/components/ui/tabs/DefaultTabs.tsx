...
// import ExampleFormTwo from "./CreateUserForm";
...
const DefaultTab: React.FC = () => {
  ...
  return (
    <div>
      <div className="p-3 bg-white border border-gray-200 rounded-t-xl dark:border-gray-800">
        {/* Navigation Tabs */}
      ...
      <div className="p-6 pt-4 border border-t-0 bg-white border-gray-200 rounded-b-xl dark:border-gray-800">
        {/* Tab Content */}
