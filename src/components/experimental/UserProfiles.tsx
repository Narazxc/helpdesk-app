              ...
              <div className="grid grid-cols-1 gap-x-4 gap-y-5 lg:grid-cols-2 lg:gap-x-6">
                ...
                <div className="lg:col-span-2">
                  ...
                  {isEditing ? (
                    <input
                      type="text"
                      value={currentUserProfile?.operatingId}
            ...
            <div className="flex gap-3 w-full lg:w-auto">
              {isEditing ? (
                <>
                  ...
                  <button
                    onClick={handleSave}
                    className="flex flex-1 lg:flex-none items-center justify-center gap-2 rounded-full bg-blue-600 px-4 py-3 text-sm font-medium text-white shadow-sm hover:bg-blue-700"
                  >
                    <svg
                      className="fill-current"
                      width="18"
...
//       </h4>
//       <p className="text-sm text-gray-500 dark:text-gray-400">
//         Change your password or recover your current one. After a successful
//         password update, you will be redirected to the login page where you can
